...
local nvim = vim
local install_root_dir = nvim.fn.stdpath("config") .. "/lua/lsp_servers"
local elements = {}
...
local default_settings = {
    ...
    log_level = nvim.log.levels.INFO,
...
elements.servers = { "vimls", "lua_ls", "gopls", "pyright", "rust_analyzer", "yamlls", "sqlls", "jsonls", "html",
    "cssls", "bashls", "prosemd_lsp", "denols", "taplo" }

mason.setup(default_settings)
mason_lspconfig.setup({
    ensure_installed = elements.servers,
    automatic_installation = false, -- 自动安装
})
